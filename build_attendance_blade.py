...
blade_content = """@extends('layouts.manager')
...
<div class="row justify-content-center">
    <div class="col-lg-12">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
            <div>
                <h2 class="h3 font-outfit text-white mb-1">Attendance Dashboard</h2>
            ...
            <div class="d-flex flex-wrap gap-2 align-items-center">
                ...
                <div class="card bg-slate-900 border-slate-700 p-1 rounded-3">
                    <form action="{{ route('manager.attendance-registry') }}" method="GET" class="d-flex gap-2 align-items-center m-0" id="filterForm">
                        <div class="d-flex align-items-center bg-slate-800 rounded-2 px-2 border border-slate-700">
                            <span class="text-secondary small me-2"><i class="bi bi-calendar-range"></i></span>
                            <input type="date" name="start_date" id="startDate" class="form-control form-control-sm border-0 bg-transparent text-white shadow-none px-1" value="{{ $startDate }}" required style="width: 120px;">
                            <span class="text-secondary mx-1">-</span>
                            <input type="date" name="end_date" id="endDate" class="form-control form-control-sm border-0 bg-transparent text-white shadow-none px-1" value="{{ $endDate }}" required style="width: 120px;">
                        </div>
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end bg-slate-900 border-slate-700 shadow">
                                <li><h6 class="dropdown-header text-slate-400 text-uppercase" style="font-size: 10px;">Daily</h6></li>
                                <li><a class="dropdown-item text-white hover-slate-800" href="#" onclick="setQuickDate('{{ now()->toDateString() }}', '{{ now()->toDateString() }}')">Today</a></li>
                                <li><a class="dropdown-item text-white hover-slate-800" href="#" onclick="setQuickDate('{{ now()->subDay()->toDateString() }}', '{{ now()->subDay()->toDateString() }}')">Yesterday</a></li>
                                <li><hr class="dropdown-divider border-slate-700"></li>
                                <li><h6 class="dropdown-header text-slate-400 text-uppercase" style="font-size: 10px;">Monthly / Yearly</h6></li>
                                <li><a class="dropdown-item text-white hover-slate-800" href="#" onclick="setQuickDate('{{ now()->startOfMonth()->toDateString() }}', '{{ now()->endOfMonth()->toDateString() }}')">This Month</a></li>
                                <li><a class="dropdown-item text-white hover-slate-800" href="#" onclick="setQuickDate('{{ now()->subMonth()->startOfMonth()->toDateString() }}', '{{ now()->subMonth()->endOfMonth()->toDateString() }}')">Last Month</a></li>
                                <li><a class="dropdown-item text-white hover-slate-800" href="#" onclick="setQuickDate('{{ now()->startOfYear()->toDateString() }}', '{{ now()->endOfYear()->toDateString() }}')">This Year</a></li>
                            </ul>
                        </div>
                    </form>
                </div>

                <button type="button" class="btn accent-btn btn-sm d-inline-flex align-items-center rounded-3 px-3 py-2 text-white shadow-lg ms-2" data-bs-toggle="modal" data-bs-target="#logAttendanceModal">
        ...
        <div class="row g-3 mb-4">
            <div class="col-md-2 col-sm-4">
                <div class="card bg-slate-900 border-slate-700 shadow-sm h-100 p-3">
                    <div class="text-secondary small font-semibold text-uppercase tracking-wider mb-1">Total Logs</div>
                    <div class="h3 text-white mb-0">{{ $teamTrends['total_logs'] ?? 0 }}</div>
                </div>
            </div>
            <div class="col-md-2 col-sm-4">
                <div class="card bg-slate-900 border-slate-700 shadow-sm h-100 p-3">
            ...
            <div class="col-md-4 col-sm-8">
                <div class="card bg-slate-900 border-slate-700 shadow-sm h-100 p-3" style="border-left: 4px solid #6366f1 !important;">
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-12">
                <div class="card glass-card p-4 border border-slate-800 shadow-2xl">
                    <h4 class="h5 font-outfit text-white mb-3">Attendance Analytics Summary ({{ \\Carbon\\Carbon::parse($startDate)->format('M d') }} - {{ \\Carbon\\Carbon::parse($endDate)->format('M d, Y') }})</h4>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0 text-white" style="--bs-table-bg: transparent; --bs-table-hover-bg: rgba(255, 255, 255, 0.02); --bs-table-border-color: #334155;">
                            <thead class="text-secondary" style="font-size: 11px;">
                                <tr>
                                    <th scope="col" class="pb-3 border-slate-800 uppercase font-semibold tracking-wider">Member</th>
                                    <th scope="col" class="pb-3 border-slate-800 uppercase font-semibold tracking-wider text-center">Percentage</th>
                                    <th scope="col" class="pb-3 border-slate-800 uppercase font-semibold tracking-wider text-center">Score</th>
                                    <th scope="col" class="pb-3 border-slate-800 uppercase font-semibold tracking-wider text-center">Present</th>
                                    <th scope="col" class="pb-3 border-slate-800 uppercase font-semibold tracking-wider text-center">Late</th>
                                    <th scope="col" class="pb-3 border-slate-800 uppercase font-semibold tracking-wider text-center">Absent</th>
                                    <th scope="col" class="pb-3 border-slate-800 uppercase font-semibold tracking-wider text-center">Leave</th>
                                    <th scope="col" class="pb-3 border-slate-800 uppercase font-semibold tracking-wider">Raw Logs (Recent)</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach($teamMembers as $member)
                                    ...
                                    <tr>
                                        <td class="py-3">
                                            <div class="font-semibold text-slate-100">{{ $member->name }}</div>
                                        ...
                                        @if($stats && $stats['total_days'] > 0)
                                            ...
                                            <td class="py-3 text-center">
                                                <span class="badge bg-slate-800 border border-slate-700 text-info">{{ $stats['attendance_score'] }}</span>
                                            </td>
                                            <td class="py-3 text-center text-slate-300">{{ $stats['present'] }}</td>
                                            <td class="py-3 text-center text-slate-300">{{ $stats['late'] }}</td>
                                            <td class="py-3 text-center text-slate-300">{{ $stats['absent'] }}</td>
                                            <td class="py-3 text-center text-slate-300">{{ $stats['leave'] }}</td>
                                        @else
                                        ...
                                        <td class="py-3">
                                            <div class="d-flex flex-wrap gap-1" style="max-width: 200px;">
                                                ...
                                                @if(count($memberLogsMap) > 3)
                                                    <span class="badge rounded-pill bg-slate-800 text-secondary border border-slate-700 px-2 py-1" style="font-size: 9px;">
        ...
        <div class="row g-4">
            <div class="col-12">
                <div class="card glass-card p-4 border border-slate-800 shadow-2xl">
                    <h4 class="h5 font-outfit text-white mb-3">Daily Logs Details (Manage Records)</h4>
                    
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0 text-white" style="--bs-table-bg: transparent; --bs-table-hover-bg: rgba(255, 255, 255, 0.02); --bs-table-border-color: #334155;">
                            <thead class="text-secondary" style="font-size: 11px;">
                                <tr>
                                    <th scope="col" class="pb-3 border-slate-800 uppercase font-semibold tracking-wider">Date</th>
                                    <th scope="col" class="pb-3 border-slate-800 uppercase font-semibold tracking-wider">Team Member</th>
                                    <th scope="col" class="pb-3 border-slate-800 uppercase font-semibold tracking-wider">Status</th>
                                    <th scope="col" class="pb-3 border-slate-800 uppercase font-semibold tracking-wider">Check In/Out</th>
                                    ...
                                    <tr id="log-row-{{ $log->id }}">
                                        ...
                                        <td class="py-3">
                                            ...
                                            <div class="edit-mode-{{ $log->id }} d-none">
                                                <select name="status" form="edit-log-form-{{ $log->id }}" class="form-select form-select-sm border-slate-700 bg-slate-900 text-white mb-1" onchange="toggleInlineLeaveType({{ $log->id }})">
                                                ...
                                                <input type="text" id="inline-leave-type-{{ $log->id }}" name="leave_type" form="edit-log-form-{{ $log->id }}" value="{{ $log->leave_type }}" class="form-control form-control-sm border-slate-700 bg-slate-900 text-white {{ $log->status == 'leave' ? '' : 'd-none' }}" placeholder="Leave Type">
                                            </div>
                                        </td>
                                        <td class="py-3 text-secondary">
                                            ...
                                            <div class="edit-mode-{{ $log->id }} d-none">
                                                <div class="d-flex gap-1">
                                                    <input type="time" name="check_in" form="edit-log-form-{{ $log->id }}" value="{{ $log->check_in }}" class="form-control form-control-sm border-slate-700 bg-slate-900 text-white" title="Check In">
                                                    <input type="time" name="check_out" form="edit-log-form-{{ $log->id }}" value="{{ $log->check_out }}" class="form-control form-control-sm border-slate-700 bg-slate-900 text-white" title="Check Out">
                                                </div>
                                            </div>
                                        </td>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content text-white" style="background-color: #0b0f19; border: 1px solid #334155; border-radius: 20px;">
            <div class="modal-header border-bottom border-slate-800 p-4">
                <h5 class="modal-title font-outfit text-white" id="logAttendanceModalLabel">Log Member Attendance</h5>
            ...
            <form method="POST" action="{{ route('manager.store-attendance') }}">
                ...
                <div class="modal-body p-4">
                    <div class="mb-3">
                        <label class="form-label text-slate-400 small font-bold text-uppercase tracking-wider">Team Member Email <span class="text-danger">*</span></label>
                        <input type="email" name="email" class="form-control border-slate-700 bg-slate-900 text-white rounded-3 px-3 py-2.5 @error('email') is-invalid @enderror" placeholder="john.doe@company.com" value="{{ old('email') }}" required>
                        <div class="form-text text-secondary small mt-1">Must match exactly with registered email.</div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label text-slate-400 small font-bold text-uppercase tracking-wider">Date <span class="text-danger">*</span></label>
                    ...
                    <div class="mb-3">
                        <label class="form-label text-slate-400 small font-bold text-uppercase tracking-wider">Status <span class="text-danger">*</span></label>
                        <select name="status" id="statusSelect" class="form-select border-slate-700 bg-slate-900 text-white rounded-3 px-3 py-2.5" required onchange="toggleLeaveType()">
                    ...
                    <div class="mb-3 d-none" id="leaveTypeContainer">
                        <label class="form-label text-slate-400 small font-bold text-uppercase tracking-wider">Leave Type</label>
                        <input type="text" name="leave_type" class="form-control border-slate-700 bg-slate-900 text-white rounded-3 px-3 py-2.5" placeholder="e.g. Sick Leave, Vacation">
                    </div>
                    <div class="row g-2">
                        <div class="col-6">
                            <label class="form-label text-slate-400 small font-bold text-uppercase tracking-wider">Check In (Optional)</label>
                            <input type="time" name="check_in" class="form-control border-slate-700 bg-slate-900 text-white rounded-3 px-3 py-2.5">
                        </div>
                        <div class="col-6">
                            <label class="form-label text-slate-400 small font-bold text-uppercase tracking-wider">Check Out (Optional)</label>
                            <input type="time" name="check_out" class="form-control border-slate-700 bg-slate-900 text-white rounded-3 px-3 py-2.5">
                        </div>
                    </div>
                </div>
...
with open('resources/views/manager/attendance.blade.php', 'w', encoding='utf-8') as f:
    f.write(blade_content)

print("Attendance blade file updated successfully with Daily Logs CRUD and UI enhancements!")
