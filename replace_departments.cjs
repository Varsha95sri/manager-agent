...
fs.writeFileSync('d:/manager Agent/manager-agent/resources/views/manager/departments.blade.php', content);
console.log('Departments view updated with Designations!');
