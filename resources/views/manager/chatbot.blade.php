...
<div class="row justify-content-center">
    <div class="col-lg-10">
        ...
        <div class="row g-4 align-items-center mb-4">
            <div class="col-sm-8">
                <h2 class="h3 font-outfit text-dark mb-0">AI Chat Assistant</h2>
        ...
        <div class="card glass-card p-0 overflow-hidden shadow-2xl">
            ...
            <div class="bg-indigo-950 bg-opacity-25 border-bottom border-secondary-subtle p-3.5 d-flex align-items-center">
                ...
                <div class="chat-container" id="chatContainer">
                    ...
                    @empty
                        <div class="h-100 d-flex flex-column items-center justify-content-center text-center py-5">
                            <div class="bg-white shadow-sm border border-secondary-subtle text-secondary rounded-circle d-flex align-items-center justify-content-center mb-3" style="width: 56px; height: 56px;">
                            ...
                            <h5 class="text-dark">Ask anything about the team</h5>
            ...
            <div class="card-footer p-3 bg-light bg-opacity-30 border-top border-secondary-subtle">
                <form method="POST" action="{{ route('manager.chatbot.ask') }}" id="chat-form">
                    ...
                    <div class="input-group">
                        <input
                            ...
                            name="question"
                            id="question-input"
                            class="form-control rounded-start-4 border-secondary-subtle bg-white shadow-sm text-dark placeholder-secondary px-4 py-2.5 focus:outline-none"
