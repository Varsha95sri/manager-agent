            ...
            @if($errors->any())
                <div class="alert alert-danger alert-dismissible fade show border-0 rounded-4 p-3 mb-4 text-dark" style="background-color: rgba(244, 63, 94, 0.15); border-left: 4px solid #f43f5e !important;" role="alert">
                    <div class="d-flex align-items-start">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="text-rose-400 me-2 mt-1" viewBox="0 0 16 16">
                            <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                            <path d="M7.002 11a1 1 0 1 1 2 0 1 1 0 0 1-2 0zM7.1 4.995a.905.905 0 1 1 1.8 0l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 4.995z"/>
                        </svg>
                        <div>
                            <span class="text-rose-300 font-semibold mb-1 d-block">Please fix the following errors:</span>
                            <ul class="mb-0 text-rose-300 small">
